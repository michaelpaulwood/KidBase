...
const config: Config = {
  ...
  theme: {
    extend: {
      // KidBase Kid-Friendly Design System
      colors: {
        // Bright Purple - Primary brand color
        primary: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
        ...
        // Bright Green - Success and positive actions
        success: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        // Bright Pink - Fun and engaging elements
        pink: {
          50: '#fdf2f8',
          100: '#fce7f3',
          200: '#fbcfe8',
        ...
        // Bright Orange - Energy and excitement
        orange: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
        ...
        // Bright Cyan/Teal - Tech and modern feel
        cyan: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Keep secondary as blue for contrast
        secondary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      boxShadow: {
        ...
        'inset-brutal': 'inset 4px 4px 0px 0px rgba(0, 0, 0, 0.2)',
      },
    },
  },
  plugins: [],
