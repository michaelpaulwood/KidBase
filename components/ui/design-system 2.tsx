...
export function CoreButton({ 
  ...
  const variantClasses = {
    primary: 'bg-primary-500 hover:bg-primary-600 text-white shadow-lg border-2 border-black',
    secondary: 'bg-secondary-500 hover:bg-secondary-600 text-white shadow-lg border-2 border-black',
    outline: 'border-2 border-black hover:bg-primary-50 hover:text-primary-600 bg-white',
  ...
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        'font-bold rounded-2xl transition-all duration-200 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
        variantClasses[variant],
        sizeClasses[size],
        className
      )}
  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        required={required}
        className={cn(
          'w-full px-4 py-3 border-2 border-black rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all duration-200 shadow-lg',
